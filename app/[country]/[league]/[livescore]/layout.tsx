            ...
            <>
              <div className={styles.top}>
                <div className={styles.leagueName}>
                  ...
                  <Text type="heading" variation="main" weight="600" size={14}>
              ...
              <div className={styles.teamInfo}>
                ...
                <div className={[styles.teamBox, styles.teamBoxAway].join(" ")}>
                  <div className={styles.teamBoxInner}>
                ...
                <div className={styles.matchDetails}>
                  <Text type="body" variation="main-300" weight="600" size={12}>
                    Matchday 24 Of 38
                  </Text>
                  ...
                  <div className={styles.teamScores}>
                    <div className={styles.teamScoresInner}>
                      <div className={styles.clubDetails}>
                        ...
                        <div className={styles.teamNameWrapper}>
                          ...
                          <h1 className={styles.clubName}>Leichster City FC</h1>
                        </div>
                      ...
                      <div
                        className={[styles.scorerWrapper, styles.leftAuto].join(
                          " "
                        )}
                      >
                    ...
                    <div className={styles.teamScoresInner}>
                      <div className={styles.clubDetails}>
                        ...
                        >
                          <p
                            className={[styles.teamAbbr, styles.leftAuto].join(
                              " "
                            )}
                          >
                            ARS
                          </p>
                          <h1 className={styles.clubName}>Arsenal</h1>
                        </div>
                ...
                <Wrapper noBackground gapStatic={12}>
                  <>
                    <div className={styles.voteHeader}>
                      <Text type="body" variation="main" weight="600" size={12}>
                        Who will win 1x1
                      </Text>
                      <Text
                        type="body"
